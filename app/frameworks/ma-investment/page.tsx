        ...
        <section className="block">
          ...
          <div className="block-body">
            ...
            <div className="wx-step">
              ...
              <p>$33M in annual synergies against a $720M price is a <b>~22-year payback on synergies alone</b>. Long, but the strategic option value (blocking a competitor, owning a growth brand, gaining DTC capability) isn&rsquo;t fully captured in that math. If GlowDTC sustains even 25% growth (down from 38%) post-acquisition, revenue reaches ~$440M within 4 years, and the deal looks considerably stronger by Year 5.</p>
